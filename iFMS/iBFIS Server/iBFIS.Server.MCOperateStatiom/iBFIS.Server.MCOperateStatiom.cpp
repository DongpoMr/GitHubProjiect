// iBFIS.Server.MCOperateStatiom.cpp : 定义 DLL 的初始化例程。
//
...
// CiBFISServerMCOperateStatiomApp 构造
...
// 唯一的一个 CiBFISServerMCOperateStatiomApp 对象

CiBFISServerMCOperateStatiomApp theApp;


// CiBFISServerMCOperateStatiomApp 初始化
