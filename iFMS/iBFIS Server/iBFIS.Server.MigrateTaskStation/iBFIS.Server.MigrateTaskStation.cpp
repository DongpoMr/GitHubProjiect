// iBFIS.Server.MigrateTaskStation.cpp : 定义 DLL 的初始化例程。
//
...
// CiBFISServerMigrateTaskStationApp 构造
...
// 唯一的一个 CiBFISServerMigrateTaskStationApp 对象

CiBFISServerMigrateTaskStationApp theApp;


// CiBFISServerMigrateTaskStationApp 初始化
