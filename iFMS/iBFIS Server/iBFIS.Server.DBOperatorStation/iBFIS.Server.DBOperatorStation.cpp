// iBFIS.Server.DBOperatorStation.cpp : 定义 DLL 的初始化例程。
//
...
// CiBFISServerDBOperatorStationApp 构造
...
// 唯一的一个 CiBFISServerDBOperatorStationApp 对象

CiBFISServerDBOperatorStationApp theApp;


// CiBFISServerDBOperatorStationApp 初始化
