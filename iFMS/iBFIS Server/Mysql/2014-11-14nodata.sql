...
CREATE DATABASE IF NOT EXISTS ibfis;
USE ibfis;
...
CREATE TABLE `branchinfo` (
  ...
  `ParentId` varchar(60) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `businessfileinfo` (
  ...
  `ExtendedInfo` int(10) unsigned DEFAULT NULL COMMENT 'æ‰©å±•å­—æ®µ',
  `ExtendedInfo1` varchar(2000) COLLATE utf8_bin DEFAULT NULL COMMENT 'æ‰©å±•å­—æ®µ',
  `ExtendedInfo2` varchar(2000) COLLATE utf8_bin DEFAULT NULL COMMENT 'æ‰©å±•å­—æ®µ',
  `RowVersion` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'å½“å‰æ—¶é—´æˆ³',
  `SyncVersion` timestamp NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'åŒæ­¥æ—¶é—´æˆ³',
  `Migrated` int(10) unsigned DEFAULT '0',
...
INSERT INTO `purviewinfo` (`PurviewInfoID`,`ParentPurviewID`,`PurviewCode`,`Description`,`ExtendedInfo1`,`ExtendedInfo2`,`RowVersion`,`SyncVersion`) VALUES 
 (0x313233316473667364667364677265797935346667,0x313233316473667364667364677265797935346667,0x3130303037,0xE8AEBEE5A487E7AEA1E79086,'','','2014-11-10 11:38:55','0000-00-00 00:00:00'),
 (0x35303964663538622D353432382D343138382D383834322D303961646639393135393130,0x35303964663538622D353432382D343138382D383834322D303961646639393135393130,0x3130303035,0xE7B3BBE7BB9FE9858DE7BDAE,'','','2014-11-07 15:31:28','0000-00-00 00:00:00'),
 ...
 (0x666B73646A66736C666B6A73666C,0x666B73646A66736C666B6A73666C,0x3130303036,0xE8AEA1E58892E7AEA1E79086,'','','2014-11-10 11:38:08','0000-00-00 00:00:00');
...
--
-- Definition of table `taskplaninfo`
--

DROP TABLE IF EXISTS `taskplaninfo`;
CREATE TABLE `taskplaninfo` (
...
--
-- Dumping data for table `taskplaninfo`
--

/*!40000 ALTER TABLE `taskplaninfo` DISABLE KEYS */;
/*!40000 ALTER TABLE `taskplaninfo` ENABLE KEYS */;
...
--
-- Definition of procedure `proc_businessfielinfo_selbyMigrateAndcount`
--

DROP PROCEDURE IF EXISTS `proc_businessfielinfo_selbyMigrateAndcount`;

DELIMITER $$

/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`%` PROCEDURE `proc_businessfielinfo_selbyMigrateAndcount`(
iCount INT)
BEGIN
        set @sql = '
        select   RecordId,
        ...
        where';
        set @sql=concat(@sql,' Migrated = \'',0,'\'');
        if iCount > 0
        then set @sql=concat(@sql, ' LIMIT ',iCount);
        end if;
END $$
/*!50003 SET SESSION SQL_MODE=@TEMP_SQL_MODE */  $$
...
BEGIN
        ...
        ,ExtendedInfo2
        ,Migrated)
        values(iRecordId,iBusinessInfoId,iType,iFileId,iRecordBegin,iRecordEnd,iExtendedInfo,iExtendedInfo1,iExtendedInfo2,iMigrated);
END $$
/*!50003 SET SESSION SQL_MODE=@TEMP_SQL_MODE */  $$
...
--
-- Definition of procedure `proc_businessfileinfo_setMigrated`
--

DROP PROCEDURE IF EXISTS `proc_businessfileinfo_setMigrated`;

DELIMITER $$

/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`%` PROCEDURE `proc_businessfileinfo_setMigrated`(
iRecordId VARCHAR(60)
,iMigrated INT(11))
BEGIN
...
--
-- Definition of procedure `proc_businessInfo_selectbyclientidAndCount`
--

DROP PROCEDURE IF EXISTS `proc_businessInfo_selectbyclientidAndCount`;

DELIMITER $$

/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`%` PROCEDURE `proc_businessInfo_selectbyclientidAndCount`( iClientId VARCHAR(60),nCount int)
BEGIN

  set @sql = 'SELECT DISTINCT ProduceId,count(ProduceId) as count FROM businessinfo where';
  set @sql=concat(@sql,' ClientId = \'',iClientId,'\'');
  set @sql=concat(@sql,'GROUP BY produceId ORDER BY count DESC');
  set @sql=concat(@sql, ' LIMIT ',nCount);
  prepare strsql  from @sql;
  execute strsql;
  deallocate prepare strsql;
...
--
-- Definition of procedure `proc_taskplaninfo_insert`
--

DROP PROCEDURE IF EXISTS `proc_taskplaninfo_insert`;

DELIMITER $$

/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`%` PROCEDURE `proc_taskplaninfo_insert`(
iPlanId VARCHAR(60)
,iBeginTime DATETIME
,iEndTime DATETIME
,iEnable INT(11)
...
BEGIN
	...
	insert into taskplaninfo(PlanId
				,BeginTime
				,EndTime
				,`Enable`
				,OrderId)
...
--
-- Definition of procedure `proc_taskplaninfo_select`
--

DROP PROCEDURE IF EXISTS `proc_taskplaninfo_select`;

DELIMITER $$

/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`%` PROCEDURE `proc_taskplaninfo_select`(
iPlanId VARCHAR(60)
,iBeginTime DATETIME
,iEndTime DATETIME
,iEnable INT(11)
...
BEGIN
    select PlanId,BeginTime,EndTime,`Enable`,OrderId from taskplaninfo;
...
--
-- Definition of procedure `proc_taskplaninfo_update`
--

DROP PROCEDURE IF EXISTS `proc_taskplaninfo_update`;

DELIMITER $$

/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`%` PROCEDURE `proc_taskplaninfo_update`(
iPlanId VARCHAR(60)
,iBeginTime DATETIME
,iEndTime DATETIME
,iEnable INT(11)
...
BEGIN
    update taskplaninfo
    set BeginTime = iBeginTime,
        EndTime = iEndTime,
        `Enable` = iEnable,
        OrderId = iOrderId
    where PlanId = iPlanId;
