// iBFIS.Server.JZPluginStation.cpp : 定义 DLL 的初始化例程。
//
...
// CiBFISServerJZPluginStationApp 构造
...
// 唯一的一个 CiBFISServerJZPluginStationApp 对象

CiBFISServerJZPluginStationApp theApp;


// CiBFISServerJZPluginStationApp 初始化
