// iBFIS.Server.CommunicateStation.cpp : 定义 DLL 的初始化例程。
//
...
// CiBFISServerCommunicateStationApp 构造
...
// 唯一的一个 CiBFISServerCommunicateStationApp 对象

CiBFISServerCommunicateStationApp theApp;


// CiBFISServerCommunicateStationApp 初始化
